...
const Register = ({ setActivePage }) => {
    ...
    const [showPassword, setShowPassword] = useState(false); // Göz ikonu durumu
    ...
    return (
        <div className="bg-[#160604]/90 backdrop-blur-md border border-red-900/30 p-8 rounded-2xl shadow-xl w-full max-w-md mx-auto mt-10">
            <div className="text-center mb-8">
                ...
                <p className="text-stone-400 mt-2 text-sm">Hemen bir hesap oluşturun ve CV analizi yapmaya başlayın</p>
            </div>
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative flex items-center">
                        ...
                        <input
                            ...
                            required
                            className="w-full bg-[#0a0302] border border-orange-900/40 rounded-xl pl-11 pr-11 py-3 text-slate-200 text-sm focus:outline-none focus:border-orange-500 transition-colors shadow-inner"
                            placeholder="••••••••"
                        />
                        ...
                        <button
                            ...
                            className="absolute right-3 text-stone-500 hover:text-orange-500 transition-colors focus:outline-none"
                        >
                            {showPassword ? (
            ...
            <div className="mt-6 text-center text-sm text-stone-400">
                ...
                <span
                    ...
                    className="text-orange-500 hover:text-orange-400 cursor-pointer font-semibold transition-colors"
                >
                    Giriş Yapın
                </span>
            </div>
